...
class ShareView05: UIView {
    ...
    private func commonInit() {
        ...
        let nib = UINib(nibName: "ShareView_05", bundle: bundle)
        ...
        loadImage()
        shareBackground.image = UIImage(named: "ShareBackground05")
        
        textLabel.text = NSLocalizedString("QuestionsKey05", comment: "")
        titleLabel.text = NSLocalizedString("TitleKey05", comment: "")
