...
class ShareView03: UIView {
    ...
    private func commonInit() {
        ...
        let nib = UINib(nibName: "ShareView_03", bundle: bundle)
        ...
        loadImage()
        shareBackground.image = UIImage(named: "ShareBackground03")
        
        textLabel.text = NSLocalizedString("QuestionsKey03", comment: "")
        titleLabel.text = NSLocalizedString("TitleKey03", comment: "")
