...
class ShareView02: UIView {
    ...
    private func commonInit() {
        ...
        let nib = UINib(nibName: "ShareView_02", bundle: bundle)
        ...
        loadImage()
        shareBackground.image = UIImage(named: "ShareBackground02")
        
        textLabel.text = NSLocalizedString("QuestionsKey02", comment: "")
        titleLabel.text = NSLocalizedString("TitleKey02", comment: "")
